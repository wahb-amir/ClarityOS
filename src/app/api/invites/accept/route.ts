...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const messages: Record<string, string> = {
      ...
      INVITE_EXPIRED:
        "This invitation has expired. Please ask the developer for a new one.",
      INVITE_EMAIL_MISMATCH:
        "This invitation was not sent to your account. Please make sure you are logged in with the correct email address.",
    };
