...
export type BlockerType = 'client_action_required' | 'technical_issue' | 'external_dependency' | 'payment_blocker'
...
const BlockerSchema = new Schema<IBlocker>({
  ...
  type: { type: String, enum: ['client_action_required', 'technical_issue', 'external_dependency', 'payment_blocker'], required: true },
