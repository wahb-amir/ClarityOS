      ...
      <div className="flex items-start gap-4 mb-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-text-primary text-base mt-2 font-medium">
            ...
            {project.devs?.length
              ? project.devs.map((d) => d.name).join(", ")
              : "Unassigned"}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.devs.map((dev) => (
                      <div
                        key={dev._id}
                        className="flex items-center gap-2 bg-bg-surface border border-border px-3 py-1.5 rounded-full text-sm"
                      >
                        {dev.image ? (
                          <img
                            src={dev.image}
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {project.invites
                      ...
                      .map((invite) => (
                        <div
                          key={invite._id}
                          className="flex flex-col gap-1 bg-bg-surface border border-[#7C3AED]/30 px-3 py-1.5 rounded-xl text-sm opacity-80"
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] bg-[#7C3AED]/10 text-[#7C3AED] px-1.5 py-0.5 rounded-sm font-semibold uppercase tracking-wider ml-1">
                              Pending
                            </span>
                          </div>
